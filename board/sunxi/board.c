...
static const uint8_t st7701_init_seq[] = {
    ...
    WRITE_C8_D16,0xC0,0x4F,0x00, //Display Line Setting   //640
    WRITE_C8_D16,0xC1,0x07,0x02, //Porch Control  
    WRITE_C8_D16,0xC2,0x31,0x05,
    ...
    WRITE_C8_D8, 0xB0, 0x53,
    WRITE_C8_D8, 0xB1, 0x60,
...
//V0.2
#define ST7701_CS_PIN		SUNXI_GPE(3)
#define ST7701_SDA_PIN		SUNXI_GPE(4)
#define ST7701_SCK_PIN		SUNXI_GPD(19)
